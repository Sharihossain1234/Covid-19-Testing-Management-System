...
$query="insert into tbl_customer (id,CustomerName,Address,City,PostalCode,Country) values('$id','$CustomerName','$Address','$City','$PostalCode','$Country');";

$result = mysqli_multi_query($con, $query);
if ($result) {
echo '<script>alert("Information Add Sucssesfully  "+"'.$orderno.'")</script>';
  echo "<script>window.location.href='admin add ambulance .php'</script>";
} 
else {
...
<!-- CSS Styles -->
    ...
    <title>Sun Healthcare |Add Ambulance Information</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid"style="color:black;">
                    ...
                    <!-- Page Heading -->
				 <a class="shower" href="#">Add Ambulance Information  </a><br><br>  

 <button><a href="admin ambulance.php"style="background:green;color:white;">Veaw ambulance List</a></button> 
<button><a href="delete.php"style="background:green;color:white;">Delete ambulance List</a></button><br><br> 				 
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary"style="color:black;"></h6>
                                </div>
                                <div class="card-body"style="color:black;">
                        <div class="form-group"style="color:black;">
                            <label>Name of Ambulance Service</label>
                          <input type="text" class="form-control" id="CustomerName" name="CustomerName"  placeholder="Enter name"  required="true">					   
											
											   <img src="microphone-3404243_1280.png" width="40px" onclick="startDictation('fullname')">
                                        </div>
										
                                           <div class="form-group">
                                              <label>Hotline/Phone No</label>
                                            <input type="text" class="form-control" id="Address" name="Address" placeholder="Enter Phone" required="true">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="City" name="City" placeholder="Enter District" required="true">
											 <img src="microphone-3404243_1280.png" width="40px" onclick="startDictation('govtidnumber')">
                               ...
                               <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="PostalCode" name="PostalCode" required="true" placeholder="Enter postal code"></textarea>
