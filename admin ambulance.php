...
<?php include_once('includes/topbar.php');?>
   ...
   <button onClick="window.print()" class=" fa fa-print"style="background:lightblue;">print</button><br><br>
	 ...
	 <a class="shower" href="#">Emergency Ambulance Information </a><br><br> 
   ...
   <button><a href="delete.php"style="background:green;color:white;">Delet ambulance</a></button>
   <br />
   <div class="table-responsive">
    ...
    <table class="table table-bordered table-striped"style="color:black;">
     <thead>
      <tr>	
	   <th>Serial no</th>
       <th>List of ambulance services</th>
       <th>Hotline</th>
       <th>District</th>
       <th>Postal Code</th>
       <th>country</th>
