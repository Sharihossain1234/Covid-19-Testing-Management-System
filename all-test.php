...
$tid=intval($_GET['tid']);    
$query=mysqli_query($con, "delete from tbltestrecord  where id='$tid'");
...
<head>
    ...
    <title>Sun Healthcare | All Tests</title>
...
<?php include_once('includes/topbar.php');?>
    ...
    <div class=" print-container">		
					<a class="shower" href="#">All Tests</a><br><br>
                    ...
                    <div class="card shadow mb-4"style="color:black;">
                        <div class="card-header py-3"style="color:black;">
                            <h6 class="m-0 font-weight-bold text-primary"style="color:black;">All Tests</h6>
                        </div>
