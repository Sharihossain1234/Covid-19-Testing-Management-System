...
<head>
    ...
    <title>Sun Healthcare | Assigned Tests</title>
...
<?php include_once('includes/topbar.php');?>
    ...
    <div class=" print-container">	
                    <!-- Page Heading -->
					<a class="shower" href="#">Assigned To Phlebotomist</a><br><br><br> 
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"style="color:black;">Assigned Tests</h6>
                        </div>
