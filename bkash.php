...
<?php include_once('includes/topbar.php');?>
	...
	<button onClick="window.print()" class=" fa fa-print"style="background:lightblue;">print</button><br><br>
     ...
     <div class="print-container">
	  <a class="shower" href="#">bkash Payment recived Statement</a><br>
     ...
     <br> <img src="img/mm.png" alt="" width="400" height="250" required="true"><label for="Chinayes"><big></big></label><br/>
