...
<head>
    ...
    <title>Sun Healthcare | B/w Dates Report</title>
...
<button onClick="window.print()" class=" fa fa-print"style="background:lightblue;">print</button><br><br>
    <div class="row print-container">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"style="color:black;">Dates to Dates Report Result From: <?php echo $fdate;?> to <?php echo $tdate;?> </h1>
    

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4"style="color:black;">
                        <div class="card-header py-3"style="color:black;">
                            <h6 class="m-0 font-weight-bold text-primary"style="color:black;">Dates to Dates Report Result</h6>
                        </div>
