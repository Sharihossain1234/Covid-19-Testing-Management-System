...
if($count>0)
{
echo "<span style='color:red'>NID/Birthcertificate  number already Registered. Please try with another Govt.Issued Id  number or click on this <a href='registered-user-testing.php'>Registered Users</span>";
 echo "<script>$('#submit').prop('disabled',true);</script>";
} else{
	
	echo "<span style='color:green'>NID/Birthcertificate  number  available for Registration .</span>";
