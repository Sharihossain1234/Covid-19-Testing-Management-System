...
if(!empty($_POST["address"])) {
	$address= $_POST["address"];
		...
		$result =mysqli_query($con,"select id from nagad where FullAddress='$address'");
...
echo "<span style='color:red'>Transaction ID already Exist. Please try with right Transaction ID  </span>";
 echo "<script>$('#submit').prop('disabled',true);</script>";
	...
	echo "<span style='color:green'>Nagad Transaction ID number available for Payment Statemen.</span>";
