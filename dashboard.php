...
<head>
    ...
    <title>Sun Healthcare  | Admin Dashboard</title>
...
<?php include_once('includes/topbar.php');?>
                ...
                <!-- Begin Page Content -->
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <a class="shower" href="#">Admin Dashboard </a><br><br> 
                        <a href="Generator.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
