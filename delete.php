...
<!-- CSS Styles -->
    ...
    <title>Sun Healthcare|Delete data from Ambulance list </title>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                ?>
				  <button><a href="admin ambulance.php"style="background:green;color:white;">Veaw Ambulance</a></button>
   <button><a href="admin add ambulance .php"style="background:green;color:white;">Add ambulance</a></button>

                <div class="card mt-5"style="background:black;">
                    <div class="card-header"style="background:lightblue;">
                        <h4>Delete data from Ambulance list</h4>
                    </div>
                    <div class="card-body">
