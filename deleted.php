...
<!-- CSS Styles -->
    ...
    <title>Sun Healthcare| Deleted paisent Symtoms list</title>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                ?>
				 <button><a href="admin question.php"style="background:green;color:white;">veaw Pataient List</a></button> 
                   <div class="card mt-5"style="background:black;">
                    <div class="card-header"style="background:lightblue;">
                        <h4>Delete Data From pataient Symtoms list</h4>
                    ...
                    <div class="card-body">
                        ...
                        <form action="coded.php" method="POST">
                            <div class="froum-group mb-3"style="color:black;">
                                <label for=""></label>
                                <input type="text" name="delete_stud_id" placeholder="Enter Serial no.." class="form-control"style="color:black;">
                            </div>
                            <div class="froum-group mb-3"style="color:black;">
