...
<head>
    ...
    <title>Sun Healthcare | Edit Phlebotomist</title>
 ...
 <div class="form-group">
                  ...
                  <div class="form-group">
                            <label>Employee Id</label>
                             <input type="text" class="form-control" id="empid" name="empid"  value="<?php echo $row['EmpID'];?>"  readonly="true"style="background:#566573;color:white;" >
