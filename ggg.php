...
<?php include_once('includes/sidebar.php');?>
  ...
  <a class="shower" href="#"> Covid-19 testing registration form </a><br> <br>
                        ...
                        <div class="form-group"style="color:black">
                          <label> Registred serial No.</label>
                          <input type="text" class="form-control"  name="id"  placeholder="Enter Registred Serial No." " title="letters only" required="true"style="color:black">					   
											
											   
                                        </div>
									 <div class="form-group"style="color:black">
                            <label>Mobile Number</label>
                          <input type="text" class="form-control"  name="govtidnumber"  placeholder="Enter New Mobile Number" " title="letters only" "style="color:black">					   
										
											   
                                        </div>
								 <div class="form-group"style="color:black">
                            <label>Home Address</label>
                          <input type="text" class="form-control"  name="address"  placeholder="Enter New Home Address" " title="letters only" style="color:black">					   
  ...
  <input type="submit" name="update" value="UPDATE DATA"style="background:green;"/>
  </form>
    </div>
                <!-- /.container-fluid -->
