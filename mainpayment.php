...
$query="insert into payment(FullName,FullAddress,State,zila,payment,testtype) values('$fname','$address','$state','$zila','$payment','$testtype');";

$result = mysqli_multi_query($con, $query);
if ($result) {
			
echo '<script>alert("bkash Payment statement successfully send "+"'.$orderno.'")</script>';
  echo "<script>window.location.href='registredpayment.php'</script>";
} 
else {
...
<!-- CSS Styles -->
    ...
    <title>Sun Healthcare| bKash Payment</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
     <a class="shower" href="#">bkash Payment </a><br> <br>
	<h2>bkash Merchant No:01750424829</h2>	<br>
...
<form name="newtesting" method="post">
  <div class="row">
                        ...
                        <div class="col-lg-6">
                          ...
                          <a href="registredpayment.php" class="-btn -bg -txt">
  verify statement
</a>
                            <br> <img src="img/mm.png" alt="" width="300" height="250" required="true"><label for="Chinayes"><big></big></label><br/>
                        ...
                        <div class="form-group"style="color:black">
                          ...
                          <input type="text" class="form-control" id="state" name="state"  placeholder="Enter full name" " title="letters only" required="true"style="color:black">					   
                                  ...
                                  <input type="text" class="form-control" id="address" name="address" placeholder="Enter bkash Transaction ID"  required="true"maxlength="10" onBlur="mobileAvailability()"style="color:black">
                     ...
                     <div class="col-lg-6">
                           ...
                           <div class="card shadow mb-4"style="background:#DE3163;">
                                <div class="card-header py-3"style="background:#DE3163;">
                                    <h6 class="m-0 font-weight-bold text-primary"></h6>
                                </div>
                                <div class="card-body">
                             <div class="form-group"style="color:white;">
*Go to your bKash Mobile Menu by dialing: *247# or using bkash app<br><br>
*Choose "Payment"<br><br>
*Enter the Merchant bKash Account Number: 01750424829<br><br>
*Enter the amount <br><br>
*Enter a reference: 1<br><br>
*Enter the Counter Number: 1<br><br>
*Now enter your bKash Mobile Menu PIN to confirm<br><br>
*Done! You will receive a confirmation message from bKash<br><br>
