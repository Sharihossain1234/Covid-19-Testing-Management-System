...
<?php include_once('includes/topbar.php');?>
	...
	<button onClick="window.print()" class=" fa fa-print"style="background:lightblue;">print</button><br><br>
     ...
     <div class="print-container">
	  <a class="shower" href="#">Nagad Payment recived Statement</a><br>
        
    
  
     <br> <img src="img/Screenshot (110).png" alt="" width="400" height="250" required="true"><label for="Chinayes"><big></big></label><br/>
   ...
   <div class="form-group">
    <div class="row">
     <div class="col-md-5"style="color:black;"><br/>
      <input type="text" id="tags"placeholder="Search..." class="form-control"style="color:black;" data-role="tagsinput" />
     </div>
	
     <div class="col-md-2"style="color:black;"><br/>
      <button type="button" name="search" class="btn btn-primary"style="color:white;" id="search">Search</button>
     </div>
    </div>
   </div>              
   ...
   success:function(data)
   {
    ...
    if(data.length > 0)
    {
     for(var count = 0; count < data.length; count++)
     {
      ...
      html += '<td>'+data[count].zila+'</td>';
      html += '<td>'+data[count].state+'</td>';	
	  html += '<td>'+data[count].testtype+'</td>';
      html += '<td>'+data[count].FullAddress+'</td>';
...
$(document).ready(function(){  
     $('#editable_table').Tabledit({
      ...
      columns:{
       identifier:[0, "ID"],
       editable:[[1, 'FullName'], [2, 'FullAddress'],[3, 'zila'],[4, 'state'],[5, 'payment'],[6, 'testtype']]
      },
      restoreButton:false,
