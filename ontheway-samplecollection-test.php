...
if (strlen($_SESSION['aid']==0)) {
  header('location:ontheway-samplecollection-test.php');
  } else{
...
<head>
    ...
    <title>Sun Healthcare | On the Way for sample Collection</title>
...
<?php include_once('includes/topbar.php');?>
    ...
    <div class=" print-container">
					<a class="shower" href="#">On the Way  sample Collection</a><br><br><br><br>
   
<div class="row ">
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4"style="color:black;">
                        <div class="card-header py-3"style="color:black;">
                            <h6 class="m-0 font-weight-bold text-primary"style="color:black;">On the Way Sample collection</h6>
                        </div>
                        <div class="card-body">
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0"style="color:black;">
                                    ...
                                    <tbody>
<?php $query=mysqli_query($con,"select tbltestrecord.OrderNumber,tblpatients.FullName,tblpatients.GovtIssuedIds,tblpatients.MobileNumber,tbltestrecord.TestType,tbltestrecord.TestTimeSlot,tbltestrecord.RegistrationDate,tbltestrecord.id as testid from tbltestrecord
