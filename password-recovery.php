...
<head>
    ...
    <title>Sun Healcare | Password recovery</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
								 ...
								 <h3 align="center" style="margin-top:4%;color:green"><img src="img/logo.jpeg" alt="" width="100" height="80"style="color:black;"><b><i>Sun Healthcare</i></b></h3>
                                ...
                                <input type="text" name="contactno" placeholder="Contact Number" autocomplete="off" class="form-control">
                                    ...
                                    <div class="form-group">
									  ...
									  <p>(please set strong Password)</p>
                                        </div>
