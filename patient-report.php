...
<head>
    ...
    <title>Sun Healthcare | Patient Report </title>
...
?>
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"style="color:black;">Search Result Againt '<?php echo $searchdata;?>' </h1>
    

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"style="color:black;">Search Report Results</h6>
                        </div>
                        <div class="card-body">
