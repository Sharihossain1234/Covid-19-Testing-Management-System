...
<head>
    ...
    <title>Sun Healthcare | New Test Request</title>
...
<?php include_once('includes/topbar.php');?>
     ...
     <div class="print-container">	
					 <a class="shower" href="#">New Test Requests</a><br><br>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"style="color:black;">New Test Requests</h6>
                        </div>
...
?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['FullName'];?></td>
											 <td><?php echo $row['GovtIssuedIds'];?></td>
