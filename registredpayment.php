...
<form method="post">
  <div class="row">
                       ...
                       <div class="form-group">
                                             ...
                                             <label>Enter bKash Transaction ID for Verify Statement</label>
                                            
										<input type="text" class="form-control" id="address" name="address" placeholder="Enter bKash Transaction ID"required="true" maxlength="17"  >
...
<h3 align="center" style="color:red">Payment statement of bkash Transaction ID  "<?php echo $_POST['address'];?>"</h3>
<hr/>
    <?php
    $address=($_POST['address']);
    $sql=mysqli_query($con,"select * from  payment where FullAddress='$address'");
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4"style="background:#DE3163;">
                                <div class="card-header py-3"style="background:#DE3163;">
                                    <h6 class="m-0 font-weight-bold text-primary"style="color:white;">bkash Payment statement</h6>
                                </div>
                                <div class="card-body">
...
<td colspan="2" align="center"><input type="submit" id="button" name="submit" value="Payment Statement invoice"style="background:black;color:white"></td>
	                                          ...
	                                          <img src="img/mm.png" alt="" width="250" height="200" required="true"><label for="Chinayes"><big></big></label><br/>
                                        ...
                                        <div class="form-group">
	                                       ...
	                                       <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="testtype" name="testtype" placeholder="Voter id/ Birth Certificate /Driving License "value="<?php echo $result['testtype']; ?>" readonly="true"style="background:#566573;color:white;">
											   ...
											   <div class="form-group">
                                             <label><b>bkash Transaction ID</b></label>                                      
