...
<head>
    ...
    <title>Sun Healthcare | Sample Collected Tests</title>
...
<?php include_once('includes/topbar.php');?>
				...
				<button onClick="window.print()" class=" fa fa-print"style="background:lightblue;">print</button><br><br>
					...
					<a class="shower" href="#">Sample Collected Tests</a><br><br>
                    ...
                    <div class="card shadow mb-4"style="color:black;">
                        <div class="card-header py-3"style="color:black;">
                            <h6 class="m-0 font-weight-bold text-primary"style="color:black;">Sample Collected Tests</h6>
                        </div>
