...
<head>
    ...
    <title>Sun Healthcare| Sample Sent to lab</title>
...
<?php include_once('includes/topbar.php');?>
    ...
    <div class="print-container">	
					<a class="shower" href="#">Sample Sent to lab</a><br><br>
                    ...
                    <div class="card shadow mb-4"style="color:black;">
                        <div class="card-header py-3"style="color:black;">
                            <h6 class="m-0 font-weight-bold text-primary"style="color:black;">Sample Sent to lab</h6>
                        </div>
