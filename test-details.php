...
<head>
    ...
    <title> Sun Healthcare | Test Details</title>
...
<button onClick="window.print()" class=" fa fa-print"style="background:lightblue;">print</button><br><br>
    <div class=" print-container">
        ...
        <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"style="color:black;">Test Details: <?php echo intval($_GET['oid']);?></h1>
...
<!-- personal information --->
                        ...
                        <div class="col-lg-6"style="color:black;">
                            ...
                            <div class="card shadow mb-4"style="color:black;">
                                <div class="card-header py-3"style="color:black;">
                                    <h6 class="m-0 font-weight-bold text-primary"style="color:black;">Personal Information</h6>
                                </div>
 ...
 <table class="table table-bordered"  width="100%" cellspacing="0"style="color:black;">
    ...
    <tr>
    <th>NID or Birthcertificate No.</th> 
...
<?php if($row['FinalReport']!=''):?>
  <tr>
    ...
    <td><a href="reportfiles/<?php echo $row['FinalReport'];?>" target="_blank"style="background:green;color:white;"><b>Download</b></a></td>
    </tr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content"style="background:lightblue;">
      <div class="modal-header"style="background:lightblue;">
        <h4 align="left"style="color:black;">Assign to</h4>
          <button type="button" class="close" data-dismiss="modal"style=";color:red;">&times;</button>
      </div>
      <div class="modal-body">
        
    <form method="post">
          <p>  <select class="form-control" name="assignto" required="true"style="color:black;">
            <option value=""style="color:black;">--Select Phlebotomist--</option>
            <?php $sql=mysqli_query($con,"select FullName,EmpID from tblphlebotomist");
            while ($result=mysqli_fetch_array($sql)) {
            ?>
            <option style="color:black;" value="<?php echo $result['FullName']."-".$result['EmpID'];?>"><?php echo $result['FullName'];?>-(<?php echo $result['EmpID'];?>)</option>
        <?php } ?>
            </select></p>
            <p>
     <input type="submit" class="btn btn-primary btn-user btn-block" name="submit" id="submit">   </p> 
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"style="background:red;color:white;">Close</button>
      </div>
  </form>
    </div>
...
<div id="takeaction" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <!-- Modal content-->
    <div class="modal-content"style="background:lightblue;color:black;">
...
<form method="post" enctype="multipart/form-data" >
          <p>  <select class="form-control" name="status" id="status" required="true"style="color:black;">
...
endwhile;
  ?>
       ...
       <p>
<textarea name="remark" class="form-control" required="true" placeholder="Remark (Max 500 Characters)"style="color:black; maxlength="500" rows="5"></textarea>  </p> 
  <p>
