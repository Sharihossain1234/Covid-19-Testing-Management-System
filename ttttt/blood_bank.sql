...
--
-- Table structure for table `tbl_employeed`
--

CREATE TABLE `tbl_employeed` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `tbl_employeed`
--

INSERT INTO `tbl_employeed` (`id`, `name`, `address`, `gender`, `designation`, `age`, `images`) VALUES
...
--
-- Indexes for table `tbl_employeed`
--
ALTER TABLE `tbl_employeed`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_employeed`
--
ALTER TABLE `tbl_employeed`
